...
<form class="form-inline d-flex" type="get" action="{{ url("/search/computer")}}">				
	<input class="form-controll mr-sm-2" type="search" name= "query" placeholder="Search Products...." autocomplete="off">
